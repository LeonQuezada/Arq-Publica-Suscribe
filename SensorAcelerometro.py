...
#--------------------------------------------------------------------------------------------------
# Archivo: SensorAcelerometroCardiaco.py
...
class SensorAcelerometro:
    ...
    def start_service(self):
        ...
        acelerometro_generado = self.simulate_data()
        mensaje = 'RC:' + str(self.id) + ':' + self.nombre + \
            ':' + str(acelerometro_generado)
        #   +----------------------------------------------------------------------------+
        ...
        print('+---------------+--------------------+-------------------------------+-------+')
        print('|      ' + str(self.id) +'     |     ' + self.nombre +'     |    Acelerometro ENVIADO       |  ' + str(acelerometro_generado) + '  |')
        print('+---------------+--------------------+-------------------------------+-------+')
        print('')
        connection.close()
